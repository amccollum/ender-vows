  ...
  'Vows Result Types': [
    {
      'A test': {
        ...
        'that throws an error shows up as errored': function(topic) {
          throw new Error('The error that was thrown');
        },
        'that has a string value shows up as pending': 'This test is pending.'
      },
      'When the topic throws an error': {
        ...
        'but they can anticipate it like a normal error': function(err) {
