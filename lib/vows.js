(function() {
  var assert, assertTypeOf, callback, defaultMessage, defaultMessages, defaults, events, isArray, isObject, isString, key, n, report, stylize, typeOf, vows, _ref, _stack;
  ...
  vows.Context = (function() {
    ...
    function Context(description, content, options, parent) {
      ...
      var context, i, key, value, _i, _len, _len2, _ref2, _ref3, _ref4, _ref5;
    ...
    Context.prototype.run = function(topics) {
      var batch, child, cur, key, next, _fn, _ref2, _ref3;
    ...
    Context.prototype.end = function(result) {
      var context, key, parts, _i, _len, _ref2, _ref3, _ref4;
      ...
      if (this.parent != null) {
        _ref4 = ['running', 'honored', 'pending', 'broken', 'errored'];
  ...
  vows.Runner = (function() {
    ...
    Runner.prototype._totalTests = function() {
      var child, groupTotal, key, _ref2;
      switch (this.type) {
        case 'group':
          groupTotal = 0;
          _ref2 = this.content;
