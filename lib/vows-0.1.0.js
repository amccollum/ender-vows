(function() {
  var assert, deepEqual, equal, events, expectedException, fail, isArguments, isArray, notDeepEqual, notEqual, notStrictEqual, objEquiv, ok, streams, strictEqual, _deepEqual, _ref, _throws;
...
able = false;
  ...
  vows.Context = (function() {
    ...
    Context.prototype.run = function(topics) {
      var async, batch, child, context, cur, hasTests, key, next, value, _fn, _ref2, _ref3;
